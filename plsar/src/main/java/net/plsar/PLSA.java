...
public class PLSA {
    ...
    public static class R {
            ...
            public class PartitionedExecutor implements Runnable{
                String guid;
                String RENDERER;
            ...
            public R addViewRenderer(Class<?> viewRenderer){
                this.viewRenderers.add(viewRenderer);
                return this;
            }

            public R setPersistenceConfig(PersistenceConfig persistenceConfig) {
