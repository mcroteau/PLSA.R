...
<form action="/items/update/${business.id}/${item.id}" method="post" enctype="multipart/form-data">
    ...
    <div class="left-float" style="margin-left:10px;width:40%;">
        ...
        <select name="active">
            <plsar:if spec="${item.active}">
                <plsar:set var="trueSelected" value="selected"/>
                <plsar:set var="falseSelected" value=""/>
            </plsar:if>
            <plsar:if spec="${!item.active}">
                <plsar:set var="trueSelected" value=""/>
                <plsar:set var="falseSelected" value="selected"/>
            </plsar:if>
