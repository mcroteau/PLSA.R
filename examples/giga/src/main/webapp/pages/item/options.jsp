...
<plsar:if spec="${itemOptions.size() > 0}">
    ...
    <plsar:each var="itemOption" items="${itemOptions}" varStatus="idx">
...
<%--                        <th>Quantity</th>--%>
                    ...
                    <plsar:each items="${itemOption.optionValues}" var="optionValue">
                        <tr>
                            <td>${optionValue.value}</td>
                            <td>${siteService.getPriceTres(optionValue.price)}</td>
