...
<plsar:if spec="${optionsCount != null &&
                        pricesCount != null}">
        ...
        <div class="model-wrapper">
            ...
            <div class="option-wrapper">
                ...
                <table class="grid">
                    ...
                    <plsar:each var="idx" begin="1" end="${optionsCount}" step="1">
                        <tr>
                            <td>
                                <select name="modelOption">
                                    <option>Option ...</option>
                                    <plsar:each items="${groupOptions}" var="groupOption">
            ...
            <div class="pricing-wrapper">
                ...
                <table class="grid">
                    ...
                    <tr>
                        <th>Label</th>
                        <plsar:each var="idx" begin="1" end="${pricesCount}" step="1">
