...
<%--                <plsar:set var="allow" value="selected"/>--%>
<%--                <plsar:set var="disallow" value=""/>--%>
<%--            </plsar:if>--%>

<%--            <plsar:if spec="${!business.allowAffiliates}">--%>
<%--                <plsar:set var="allow" value=""/>--%>
<%--                <plsar:set var="disallow" value="selected"/>--%>
<%--            </plsar:if>--%>
    ...
    <div id="flat-rate-select-wrapper" style="float:left;width:346px;">
        ...
        <select name="flatShipping" id="flat-shipping" style="width:340px;">
            ...
            <plsar:if spec="${business.flatShipping}">
                <plsar:set var="flat" value="selected"/>
                <plsar:set var="realtime" value=""/>
            </plsar:if>

            <plsar:if spec="${!business.flatShipping}">
                <plsar:set var="flat" value=""/>
                <plsar:set var="realtime" value="selected"/>
            </plsar:if>
