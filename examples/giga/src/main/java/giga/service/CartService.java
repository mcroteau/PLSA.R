...
public class CartService {
    ...
    public String view(String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String viewCheckout(String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
        Business business = businessRepo.get(businessUri);
        if(business == null){
            return "redirect:/home";
        }
    ...
    public String add(Long id, String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
...
//            }
    ...
    public void setData(Cart cart, Business business, PageCache cache, DesignRepo designRepo, ItemRepo itemRepo, CartRepo cartRepo, NetworkRequest req, SecurityManager security){
    ...
    public String minus(Long id, String businessUri, PageCache cache) {
