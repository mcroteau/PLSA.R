...
public class AffiliateService {
    ...
    public String getAffiliates(Long id, PageCache cache, NetworkRequest req, SecurityManager security){
    ...
    public String getOnboarding(PageCache cache, NetworkRequest req) {
    ...
    public String getRequests(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String status(String guid, PageCache cache) {
    ...
    public String begin(PageCache cache, NetworkRequest req) {
    ...
    public String deny(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String approve(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        BusinessRequest businessRequest = businessRepo.getRequest(id);
        cache.set("businessRequest", businessRequest);
    ...
    public String finalizeOnboarding(Long id, PageCache cache) {
