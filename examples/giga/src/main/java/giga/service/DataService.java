...
public class DataService {
    ...
    public String viewImportMedia(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String importMedia(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) throws Exception{
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String viewImportsMedia(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        String permission = Giga.BUSINESS_MAINTENANCE + businessId;
    ...
    public String viewMedias(Long businessId, Long importId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        String permission = Giga.BUSINESS_MAINTENANCE + businessId;
    ...
    public String updateMedia(Long businessId, Long importId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        String businessPermission = Giga.BUSINESS_MAINTENANCE + businessId;
    ...
    public String deleteImport(Long businessId, Long importId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String convertItems(Long businessId, Long importId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String viewItemGroupImport(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        String permission = Giga.BUSINESS_MAINTENANCE + businessId;
    ...
    public String viewItemGroups(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
...
//    public String viewIngest(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security){
//        if(!security.isAuthenticated(req)){
//            return "redirect:/";
//        }
//
...
//    }
    ...
    public String ingest(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security){
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String deleteImportedGroup(Long groupId, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String deleteGroupImport(Long ingestId, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
...
//    public String ingestOld(Long businessId, PageCache cache, HttpRequest req){
