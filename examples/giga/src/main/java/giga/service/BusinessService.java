...
public class BusinessService {
    ...
    public String businessSignup(PageCache cache, NetworkRequest req, NetworkResponse resp, SecurityManager security) throws Exception {
    ...
    public String setup(PageCache cache, NetworkRequest req, SecurityManager security){
    ...
    public String snapshot(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String create(Long id, PageCache cache, NetworkRequest req, SecurityManager security){
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        setData(id, cache, userRepo, businessRepo, req, security);
    ...
    public String signupComplete(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String showSettings(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String saveSettings(Long id, PageCache cache, NetworkRequest req, NetworkResponse resp, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String delete(Long currentId, Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String activateStripe(Long id, PageCache cache, NetworkRequest req, NetworkResponse resp, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String onboardingComplete(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public void setData(Long id, PageCache cache, UserRepo userRepo, BusinessRepo businessRepo, NetworkRequest req, SecurityManager security){
    ...
    public String get(String businessUri, PageCache cache) {
