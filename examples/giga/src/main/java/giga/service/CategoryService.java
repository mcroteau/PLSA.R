...
public class CategoryService {
    ...
    public String getItems(String businessUri, String categoryUri, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String list(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) throws Exception {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        businessService.setData(businessId, cache, userRepo, businessRepo, req, security);
    ...
    public String update(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
