...
public class ItemService {
    ...
    public String query(Long id, PageCache cache, NetworkRequest req, SecurityManager security){
    ...
    public String getItem(Long id, String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String getItemCategory(Long id, Long categoryId, String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String create(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security){
    ...
    public String list(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security){
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        businessService.setData(businessId, cache, userRepo, businessRepo, req, security);
    ...
    public String getListInactive(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        businessService.setData(businessId, cache, userRepo, businessRepo, req, security);
    ...
    public String grid(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        businessService.setData(businessId, cache, userRepo, businessRepo, req, security);
    ...
    public String edit(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String update(Long id, Long businessId, Boolean onGrid, PageCache cache, NetworkRequest req, SecurityManager security) throws IOException {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String delete(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String options(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String saveOption(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String deleteOption(Long id, Long optionId, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String saveValue(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String deleteValue(Long id, Long valueId, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public void setData(Long id, PageCache cache){
        Item item = itemRepo.get(id);
