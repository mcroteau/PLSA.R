...
public class ShipmentService {
    ...
    public String begin(String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String getRates(String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
        Business business = businessRepo.get(businessUri);
        if(business == null){
            return "redirect:/home";
        }
    ...
    public String select(String businessUri, PageCache cache, NetworkRequest req) {
        Business business = businessRepo.get(businessUri);
        if(business == null){
            return "redirect:/home";
        }
    ...
    public String createShipment(String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
        Business business = businessRepo.get(businessUri);
        if(business == null){
            return "redirect:/home";
        }
    ...
    public String save(String businessUri, PageCache cache, NetworkRequest req, SecurityManager security) {
        Business business = businessRepo.get(businessUri);
        if(business == null){
            return "redirect:/home";
        }
