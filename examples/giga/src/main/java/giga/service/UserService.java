...
public class UserService {
    ...
    public String getEdit(Long id, Long businessId, PageCache cache, NetworkRequest req, SecurityManager security){
    ...
    public String send(PageCache cache, NetworkRequest req, SecurityManager security) {
    ...
    public String resetPassword(Long id, PageCache cache, NetworkRequest req, NetworkResponse resp, SecurityManager security) {
    ...
    public String clients(Long businessId, PageCache cache, NetworkRequest req, SecurityManager security){
