...
public class DesignService {
    ...
    public String configure(Long id, PageCache cache, NetworkRequest req, SecurityManager security){
    ...
    public String list(Long id, PageCache cache, NetworkRequest req, SecurityManager security) throws Exception {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
        businessService.setData(id, cache, userRepo, businessRepo, req, security);
    ...
    public String edit(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String update(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
    ...
    public String delete(Long id, PageCache cache, NetworkRequest req, SecurityManager security) {
        if(!security.isAuthenticated(req)){
            return "redirect:/";
        }
