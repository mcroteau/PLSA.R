...
public class UserRouter {
	...
	@Get("/{shop}/signup")
	public String shopSignup(PageCache cache,
							 NetworkRequest req,
	...
	@Get("/{shop}/activity")
	public String getActivity(PageCache cache,
							  NetworkRequest req,
							  SecurityManager security,
	...
	public String getEdit(PageCache cache,
						  NetworkRequest req,
						  SecurityManager security,
	...
	@Post("/users/send")
	public String send(PageCache cache,
					   NetworkRequest req,
					   SecurityManager security){
	...
	@Post("/users/reset/{id}")
	public String resetPassword(PageCache cache,
								NetworkRequest req,
	...
	@Get("/clients/{id}")
	public String clients(PageCache cache,
						  NetworkRequest req,
						  SecurityManager security,
						  @Component Long id){
	...
	public String getPassword(PageCache cache,
							  NetworkRequest req,
							  SecurityManager security,
							  @Component String shopUri){
		Business business = businessRepo.get(shopUri);
	...
	public String sendPassword(PageCache cache,
							   NetworkRequest req,
							   SecurityManager security,
							   @Component String shopUri){
	...
	public String editUser(PageCache cache,
						   NetworkRequest req,
						   SecurityManager security,
						   @Component String shopUri,
						   @Component Long id){
	...
	public String updateUser(PageCache cache,
							 NetworkRequest req,
							 SecurityManager security,
							 @Component String shopUri){
		Business business = businessRepo.get(shopUri);
	...
	public String editPassword(PageCache cache,
							   NetworkRequest req,
							   SecurityManager security,
							   @Component String shopUri,
							   @Component Long id){
	...
	public String savePassword(PageCache cache,
							   NetworkRequest req,
							   SecurityManager security,
							   @Component String shopUri){
		Business business = businessRepo.get(shopUri);
