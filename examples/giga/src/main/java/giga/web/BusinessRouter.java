...
public class BusinessRouter {
    ...
    public String businessSignup(PageCache cache,
                                 NetworkRequest req,
    ...
    public String setup(PageCache cache,
                        NetworkRequest req,
    ...
    @JsonOutput
    @Get("/{business}/oops")
    public String oops(PageCache cache){
    ...
    @Design("/designs/auth.jsp")
    @Get("/snapshot/{id}")
    public String snapshot(PageCache cache,
                           NetworkRequest req,
                           SecurityManager security,
                           @Component Long id){
    ...
    public String signupComplete(PageCache cache,
                                 NetworkRequest req,
                                 SecurityManager security,
                                 @Component Long id){
    ...
    public String showSettings(PageCache cache,
                               NetworkRequest req,
                               SecurityManager security,
                               @Component Long id){
    ...
    public String saveSettings(PageCache cache,
                               NetworkRequest req,
                               NetworkResponse resp,
                               SecurityManager security,
                               @Component Long id){
    ...
    public String showSettingsDos(PageCache cache,
                                  NetworkRequest req,
                                  SecurityManager security,
                                  @Component Long id){
        return businessService.showSettings(id, cache, req, security);
    ...
    public String activateStripe(PageCache cache,
                                 NetworkRequest req,
                                 NetworkResponse resp,
                                 SecurityManager security,
                                 @Component Long id){
    ...
    @Post("/{shop}/register")
    public String shopRegister(PageCache cache,
                               NetworkRequest req,
                               NetworkResponse resp,
                               SecurityManager security,
    ...
    public String noop(PageCache cache){
        return "";
    }

    @Get("/stripe/onboarding/complete/{id}")
    public String onboardingComplete(PageCache cache,
                                     NetworkRequest req,
                                     SecurityManager security,
                                     @Component Long id){
