...
public class AuthRouter {
	...
	@Get("/signin")
	public String signin(PageCache cache){
	...
	@Get("/{shop}/signin")
	public String shopSignin(PageCache cache,
							 NetworkRequest req,
							 SecurityManager security,
	...
	@Get("/signup")
	public String signup(PageCache cache){
	...
	@Get("/{shop}/signout")
	public String shopSignout(PageCache cache,
							  NetworkRequest req,
							  NetworkResponse resp,
							  SecurityManager security,
							  @Component String shopUri){
