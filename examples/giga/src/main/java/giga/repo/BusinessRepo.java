...
public class BusinessRepo {
    ...
    public Business get(long id){
        ...
        Business business = (Business) dao.get(sql, new Object[] { id }, Business.class);
        return business;
    }

    public Business get(String uri){
        String sql = "select * from businesses where lower(uri) = '[+]'";
        Business business = (Business) dao.get(sql, new Object[] { uri }, Business.class);
        return business;
    }

    public List<Business> getList(){
        String sql = "select * from businesses order by id desc";
        List<Business> businesses = (ArrayList) dao.getList(sql, new Object[]{}, Business.class);
        return businesses;
    }
    ...
    public List<UserBusiness> getListUsers(Long id){
        ...
        List<UserBusiness> businesses = (ArrayList) dao.getList(sql, new Object[]{id}, UserBusiness.class);
        return businesses;
    }
    ...
    public List<User> getUsers(Long businessId) {
        ...
        List<User> users = (ArrayList) dao.getList(sql, new Object[]{ businessId }, User.class);
        return users;
    }
    ...
    public BusinessRequest getRequest(Long id){
        ...
        BusinessRequest businessRequest = (BusinessRequest) dao.get(sql, new Object[] { id }, BusinessRequest.class);
        return businessRequest;
    }

    public BusinessRequest getRequest(String guid){
        String sql = "select * from business_requests where lower(guid) = '[+]'";
        BusinessRequest businessRequest = (BusinessRequest) dao.get(sql, new Object[] { guid }, BusinessRequest.class);
        return businessRequest;
    }
    ...
    public List<BusinessRequest> getRequests(Long id) {
        ...
        List<BusinessRequest> businessRequests = (ArrayList) dao.getList(sql, new Object[]{ id }, BusinessRequest.class);
